...
gulp.task('combine-js', function () {
    return gulp.src(['./files/js/main/main-ru.js', './files/translations/ru.js', './files/js/jquery.mousewheel.js', './files/js/modules/*.js', './files/js/main-run.js', './files/extra/quotes_for_!q/ru/*'])
        .pipe(jshint())
