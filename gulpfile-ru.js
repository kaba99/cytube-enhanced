...
var jsFilesGlob = ['./src/js/main/main.js', './src/js/main/user-config.js', './src/js/main/ui.js', './src/js/main/main-ru.js', './src/translations/ru.js', './src/js/core/*.js', './src/js/extras/**/config.js'];
